        ...
        <>
            ...
            <aside className='relative w-full h-fit p-7 bg-[#1e1e1f] border border-neutral-700 text-white rounded-2xl mb-4 overflow-hidden'>
                ...
                <div className="flex flex-row xl:flex-col xl:justify-center items-center">
                    <img className='bg-neutral-700 w-24 sm:w-32 rounded-3xl xl:mt-10 me-5 xl:me-0' src="https://i.ibb.co/HqSZ6hj/my-avatar.png" alt="" />
                    <div className="flex flex-col gap-3 justify-center xl:items-center">
                        <h1 className="texxl sm:text-2xl font-semibold xl:my-5">Example name</h1>
                        <p className="bg-neutral-600 px-3 py-1 w-fit rounded-md text-[10px] sm:text-[13px]">MERN Stack Developer</p>
                    </div>
                </div>
                ...
                <div className={`${showContact} xl:block`}>
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-6 text-sm sm:text-[16px]">
                        <div className="flex gap-5">
                            <span className='flex justify-center items-center h-14 w-14 bg-[#2b2b2cbf] border border-neutral-700 rounded-md'><Icon icon="material-symbols:mark-email-unread" width="24" height="24"></Icon></span>
                            <div className="">
